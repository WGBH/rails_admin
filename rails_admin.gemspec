...
Gem::Specification.new do |spec|
  ...
  # Here we relax the kaminari requirement to allow 
  # use of jcoyne's kaminari fork, which is required
  # for hydradam. Once jcoyne's PR is merged, we
  # can go back to using rubygem's versions of both
  # kaminari and rails_admin.
